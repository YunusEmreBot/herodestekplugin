...
.setTitle(`HeroNetwork Ticket Botu`)
.setFooter(`HeroNetwork Ticket Botu - Ticketing without clutter.`, client.user.avatarURL)
.setColor('GREEN')
...
.setFooter(`HeroNetwork Ticket Botu - Ticketing without clutter`, client.user.avatarURL)).then(m => {
m.react(`🔒`)
